...
run: all
	...
	@qemu-system-riscv64 -nographic -machine virt -kernel vmlinux -bios fw_jump.bin 

debug: all
	@echo Launch the qemu for debug ......
	@qemu-system-riscv64 -nographic -machine virt -kernel vmlinux -bios fw_jump.bin -S -s
